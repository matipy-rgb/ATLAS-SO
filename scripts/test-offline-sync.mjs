    ...
    const client = {
        from(table) {
            ...
            return {
                ...
                async upsert(rows) {
                    upserts.push(structuredClone(Array.isArray(rows) ? rows : [rows]));
                    return failUpsert
...
console.log("ATLAS SO v0.9.0: cambios sin conexión preservados y permisos sensibles cerrados por defecto.");
